...
import HomePage from "./dashboard_components/WelcomePage"
import { useRouter } from 'next/router'

export default function Dashboard({username,email,rollNumber}){
    ...
    <div className="Dashboard_app">
        ...
        <div className="row">
            ...
            <div class="col-md-10 col-sm-9 col-12">
                <HomePage username={username} email={email} rollNumber={rollNumber}/>
            </div>
        </div>
    </div>
    )
